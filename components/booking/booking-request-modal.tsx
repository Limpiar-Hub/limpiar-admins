...
export function BookingRequestModal({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <SheetContent side="right" className="w-[400px] sm:w-[540px] p-0 flex flex-col h-full max-h-screen">
        ...
        <div className="px-8 py-6 flex-1 overflow-y-auto">
          <div className="space-y-8">
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-6">Booking Information</h3>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <button className="text-[#0082ed] text-sm hover:underline">Show location</button>
                  </div>
                </div>
        ...
        <div className="border-t p-8 flex justify-end gap-3 mt-auto">
          {showAssignButton ? (
            <Button className="bg-[#0082ed] hover:bg-[#0082ed]/90 w-full" onClick={onAssign}>
            ...
            <>
              ...
              <Button className="bg-[#0082ed] hover:bg-[#0082ed]/90" onClick={onApprove}>
                Approve
              </Button>
            </>
          )}
